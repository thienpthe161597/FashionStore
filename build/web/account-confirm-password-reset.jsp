        ...
        <div class="row">
          <div class="col-12">
            <div class="login-form-content">
                ...
                <div class="row">
                  <div class="col-12">
                      <input value="resetPassAfterOTP" class="form-control" type="hidden" name="action">
                    ...
                    <div class="form-group">
                      ...
                      <input id="password" class="form-control" type="password" name="cpassword" required="">
                    </div>
                  </div>
                    <div class="col-12">
                    <div class="form-group">
                        <label for="password"><a style="color: red">${mess}</a></label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-group">
                        <button type="submit" class="btn-login"><a>Reset</a></button>
                      ...
                      <div class="rememberme-account">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="defaultCheck1">
                              <a href="register" style="color: black"> Don't have account?</a> 
                          </label>
                        </div>
                      </div>
                      <a class="lost-password" href="reset">Lost your password?</a>
                    </div>
                  </div>
                </div>
              </form>
...
<!-- Mirrored from htmldemo.net/shome/shome/account-login.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 02:23:39 GMT -->
</html>