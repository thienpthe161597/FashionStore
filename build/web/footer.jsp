            ...
            <div id="widgetId-1" class="collapse widget-collapse-body">
              <div class="collapse-body">
                <div class="widget-menu-wrap">
                  <ul class="nav-menu">
                    <li><a href="contact.jsp">Home monitoring</a></li>
                    <li><a href="contact.jsp">Air Filters</a></li>
                    <li>
                      <a href="contact.jsp">Professional installation</a>
                    </li>
                    <li><a href="contact.jsp">Smart Buildings</a></li>
                    <li><a href="contact.jsp">For contractors</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="widget-item widget-account-item">
            ...
            <div id="widgetId-2" class="collapse widget-collapse-body">
              <div class="collapse-body">
                <div class="widget-menu-wrap">
                  <ul class="nav-menu">
                    <li><a href="account-login.jsp">My Account</a></li>
                    <li><a href="contact.jsp">Contact</a></li>
                    <li><a href="shop-cart.jsp">Shopping cart</a></li>
                    <li><a href="shop.jsp">Shop</a></li>
                    <li>
                      <a href="account-login.jsp">Services Login</a>
                    </li>
                  </ul>
                </div>
              </div>
    ...
    <div class="container pt--0 pb--0">
      <div class="row">
        <div class="col-md-7 col-lg-6">
          <p class="copyright">
            © 2021 Shome. Made with <i class="fa fa-heart"></i> by
            <a
              target="_blank"
