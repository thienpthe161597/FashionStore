                ...
                <tbody>
                  <tr class="cart-wishlist-item">
                    ...
                    <td class="product-action">
                      <a class="btn-cart" href="shop-cart.jsp">Add to cart</a>
                    </td>
                  </tr>
                  <tr class="cart-wishlist-item">
                    <td class="product-remove">
...
<!-- Mirrored from htmldemo.net/shome/shome/shop-wishlist.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 02:23:40 GMT -->
</html>