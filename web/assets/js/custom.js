  ...
  // Slider Range Js
    $('#price-range').slider({
      ...
      slide: function( event, ui ) {
        $('.ui-slider-handle:eq(0)').jsp( '<span>' + '$' + ui.values[ 0 ] + '</span>');
        $('.ui-slider-handle:eq(1)').jsp( '<span>' + '$' + ui.values[ 1 ] + '</span>');
      }
    });
    $('.ui-slider-handle:eq(0)').jsp( '<span>' + '$' + $( "#price-range" ).slider( "values", 0 ) + '</span>' );
    $('.ui-slider-handle:eq(1)').jsp( '<span>' + '$' + $( "#price-range" ).slider( "values", 1 ) + '</span>' );
  ...
  // Ajax Contact Form JS
    ...
    $(form).submit(function(e) {
      ...
      $.ajax({
        ...
        formMessages.jsp("<button type='button' class='btn-close' data-bs-dismiss='alert'>&times;</button>");
