                ...
                <div class="col-xl-6">
                  ...
                  <div class="product-single-info">
                    ...
                    <div class="group-product-list">
                      <span class="info-text">Buy this bundle and get off to <span class="text-primary">25%</span> of all prices.</span>
                      <table>
                        <tbody>
                          <tr>
                            <td class="choose"><input type="checkbox" checked="" disabled=""></td>
                            <td class="quantity"></td>
                            <td class="thumb"><img src="assets/img/shop/product-single/group1.webp" alt="Image"></td>
                            <td class="title"><span>Leather Mens Slipper</span></td>
                            <td class="price"><span class="pro-price"><span>£100</span></span></td>
                          </tr>
                          <tr>
                            <td class="choose"><input type="checkbox"></td>
                            <td class="quantity">1</td>
                            <td class="thumb"><img src="assets/img/shop/product-single/group2.webp" alt="Image"></td>
                            <td class="title"><a href="single-product.jsp">Modern Smart Shoes</a></td>
                    ...
                    <div class="product-quick-action">
                      ...
                      <a class="btn-theme" href="shop-cart.jsp">Add to Cart</a>
                    </div>
...
<!-- Mirrored from htmldemo.net/shome/shome/single-group-product.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 02:23:59 GMT -->
</html>