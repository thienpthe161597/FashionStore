                        ...
                        <div class="product-item">
                            <div class="inner-content">
                                <div class="product-thumb">
                                    <a href="product-detail?id=${randomPro.productID}"> <%--${randomPro.getImage() --%>
                                        <img src="${randomPro.image}" width="270" height="274" alt="Image-HasTech">
                                    </a>
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="single-product.jsp?id=${randomPro.productID}">${randomPro.getProductName()}</a></h4>
                                    <div class="prices">
...
<!-- Mirrored from htmldemo.net/shome/shome/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 02:23:33 GMT -->
</html>