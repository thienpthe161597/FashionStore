                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <c:forEach items="${listUser}" var="listUser">
                                        <tr>
                                            <td>${listUser.getUser_Name()}</td>
                                            <td>${listUser.getEmail()}</td>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${listUser.getAddress() == null}">
                                                    <div style="color: red">  User hasn't updated the address </div>
                                                    </c:when>
                                                    <c:otherwise>
                                                        ${listUser.getAddress()}
                                                    </c:otherwise>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${listUser.getPhone() == null}">
                                                        <div style="color: red">  User hasn't updated the phone </div>
                                                    </c:when>
                                                    <c:otherwise>
                                                        ${listUser.getPhone()}
                                                    </c:otherwise>
