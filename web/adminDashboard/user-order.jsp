            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="user-order" class="nav-item nav-link active"><i class="fa fa-shopping-cart me-2"></i>View Order</a>
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <form id="cancelForm-${order.orderId}" action="user-order" method="post">
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary" 
                                                            onclick="confirmCancel('${order.orderId}')">Submit
                                                    </button>
                                                </td>
                                                                ...
                                                                document.addEventListener("DOMContentLoaded", function () {
                                                                    ...
                                                                    form.addEventListener("submit", function (event) {
                                                                        ...
                                                                        if (searchInput.value.trim() === "") {
                                                                            searchInput.removeAttribute("name"); // Prevent empty parameter submission
                                                                        }
                                                                    });
                                                                });
                </script>
