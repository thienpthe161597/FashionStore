            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="order" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Oder List</a>
                                    ...
                                    <c:forEach items="${listOrderDetail}" var="listOrderDetail">
                                        ...
                                        <c:forEach items="${listOrder}" var="listOrder">
                                            <c:forEach items="${listUser}" var="listUser">
                                                <c:if test="${listOrderDetail.getOrderID() == listOrder.getOrderID()}">
                                                    <c:if test="${listOrder.getUserID() == listUser.getUser_ID()}">
                                        ...
                                        <c:forEach items="${listProductVariant}" var="listProductVariant">
                                            <c:forEach items="${listProduct}" var="listProduct">
                                                <c:if test="${listOrderDetail.getPVID() == listProductVariant.getPv_id()}">
                                        ...
                                        <c:forEach items="${listProductVariant}" var="listProductVariant">
                                                <c:if test="${listOrderDetail.getPVID() == listProductVariant.getPv_id()}">
                                                    <td>${listProductVariant.getColor()}</td>
                                                        ...
                                                        <td>${listOrderDetail.getQuantity()}</td>
                                                        <td>${listOrderDetail.getUnitPrice()}</td>
                                        </tr>                   
                                    </c:forEach>  
                                </tbody>
                            </table>
