                  ...
                  <div class="col-12">
                    <div class="pagination-items">
                      <ul class="pagination justify-content-center mb--0">
                        <li><a href="shop-three-columns.jsp">1</a></li>
                        <li><a class="active" href="shop-four-columns.jsp">2</a></li>
                        <li><a href="shop.jsp">3</a></li>
                      </ul>                    
                    </div>
                  </div>
                </div>
...
<!-- Mirrored from htmldemo.net/shome/shome/shop-four-columns.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2025 02:23:55 GMT -->
</html>