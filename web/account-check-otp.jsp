                    ...
                    <div class="register-form-content">
                        <c:if test="${regi != null}">
                            ...
                            <form action="checkOTP" method="post">
                                <div class="row">
                                    <input value="checkOTPforRegister" class="form-control" type="hidden" name="action">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="username">Your OTP</label>
                                            <input id="username" class="form-control" type="text" name="otp1" required="">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                        ...
                        <c:if test="${resetpa != null}">
                            <form action="checkOTP" method="post">
                                <div class="row">
                                    <input value="checkOTPforReset" class="form-control" type="hidden" name="action">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="username">Your OTP</label>
                                            <input id="username" class="form-control" type="text" name="otp2" required="">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
